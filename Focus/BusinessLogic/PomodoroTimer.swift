...
class PomodoroTimer: ObservableObject {
  ...
  var _durationWork: TimeInterval
  var _durationBreak: TimeInterval
  ...
  init(workInMinutes: TimeInterval, breakInMinutes: TimeInterval) {
	_durationWork = workInMinutes * 60
	_durationBreak = workInMinutes * 60
  }
